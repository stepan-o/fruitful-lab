...
- Case studies are held for V2. Keep the future proof/story work available, but hide Case Studies from V1 navigation and sitemap; `/case-studies` should redirect to `/pinterest-services` during V1.
