      ...
      <Section>
        <SectionInner className="max-w-3xl">
          ...
          <div className="mt-12 rounded-lg border border-[var(--border)] bg-[var(--surface)] p-6">
            <h2 className="text-xl font-semibold text-[var(--heading)]">Want help mapping this to your brand?</h2>
            <p className="mt-3 text-sm leading-6 text-[var(--muted)]">Book a discovery call and we will look at your content, offer, and Pinterest opportunity without guessing.</p>
            <Link className="mt-5 inline-flex min-h-11 items-center justify-center rounded-md bg-[var(--raspberry)] px-5 text-sm font-semibold text-white" href="/contact">
              Start a fit check
            </Link>
          </div>
        </SectionInner>
