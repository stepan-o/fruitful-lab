...
export const metadata = {
  title: "Terms",
  description: "Basic terms for using the Fruitful Lab website, resources, and educational content.",
  alternates: {
    canonical: "/terms/",
  },
};
    ...
    <div>
      ...
      <Section>
        <SectionInner className="max-w-3xl space-y-8">
          <section>
            <h2 className="text-2xl font-normal text-[var(--heading)]">Website content</h2>
          ...
          <section>
            <h2 className="text-2xl font-normal text-[var(--heading)]">Use of resources</h2>
            <p className="mt-3 text-sm leading-7 text-[var(--muted)]">
