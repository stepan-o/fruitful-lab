  ...
  return (
    <header className="sticky top-0 z-20 border-b border-[var(--border)] bg-[color-mix(in_srgb,var(--background)_92%,white)]/95 backdrop-blur">
      <div className="mx-auto flex min-h-20 max-w-6xl items-center justify-between gap-6 px-5 sm:px-8">
        ...
        <nav className="hidden items-center gap-5 text-sm font-medium text-[var(--muted)] md:flex" aria-label="Primary">
        ...
        <Link className="inline-flex min-h-10 items-center justify-center rounded-md bg-[var(--heading)] px-4 text-sm font-semibold text-white" href="/contact">
          Fit check
        </Link>
      </div>
    </header>
