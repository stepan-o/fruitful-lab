    ...
    return (
        <div className="bg-white text-[#171A21]">
            ...
            <section className="relative w-full overflow-hidden bg-white">
                {/* Animated backdrop now fills the entire hero band */}
                <LabAnimatedBackdrop />

                {/* Foreground hero content */}
                <div className="relative z-10 mx-auto max-w-[1360px] px-4 sm:px-6 lg:px-8 pt-14 pb-18 sm:pt-16 sm:pb-20 lg:pt-20 lg:pb-24">
