    ...
    <footer className="border-t border-[var(--border)] bg-[var(--surface)]">
      <div className="mx-auto grid max-w-6xl gap-8 px-5 py-10 text-sm text-[var(--muted)] sm:px-8 md:grid-cols-[1.2fr_1fr]">
        <div>
          ...
          <p className="mt-3 max-w-md leading-6">Boutique Pinterest marketing for content creators and specialty brands that want long-term traffic and sales from search-driven discovery.</p>
